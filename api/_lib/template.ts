...
const rglr = readFileSync(`${__dirname}/../_fonts/AvenirNextLTPro-Regular.otf`).toString('base64');
const bold = readFileSync(`${__dirname}/../_fonts/AvenirNextLTPro-Bold.otf`).toString('base64');
